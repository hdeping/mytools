...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000):
        ...
        self.layer2 = self._make_layer(block, 32, layers[1], stride=(1,2))
        self.layer3 = self._make_layer(block, 64, layers[2], stride=(1,2))
        self.layer4 = self._make_layer(block, 128, layers[3], stride=(1,2))

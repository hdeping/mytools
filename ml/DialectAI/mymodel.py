...
class LanNet(nn.Module):
    def __init__(self, input_dim=48, hidden_dim=2048, bn_dim=100, output_dim=10):
        ...
        # attention
        self.attention = attn(self.hidden_dim+1,self.hidden_dim)
    ...
    def forward(self, src, mask, target):
        ...
        attention_alpha = self.attention(torch.cat((attention_alpha,new_target),1))
        ...
        out_hidden = out_hidden.sum(dim=1)*scale
